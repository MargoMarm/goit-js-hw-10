...
function createMarkupForCounty({ name, capital, population, flags, languages }) {
	return `<img src =${flags.svg} alt='flags of ${name.official}' width=100% height=80/> <p>${name.official}</p>
	<ul class="porps"><li>Capital: ${capital}</li><li>Population: ${population}</li><li>Languages: ${Object.values(languages)}</li>
	</ul>`;
};
